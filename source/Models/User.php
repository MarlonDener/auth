    ...
    class User extends DataLayer{
        ...
        public function validateEmail()
        {
            ...
            if(!$this->id){
                ...
                $userByEmail = $this->find("email = :email AND id != :id", "email={$this->email}")->count();
            }

            if($userByEmail)
            {
                $this->fail = new Exception("O e-mail já está em uso");
                return false;
            }
        ...
        protected function validatePassword(): bool
        {
            ...
            {
                $this->fail = new Exception("Informe uma senha pelo menos 5 caracteres");
                return false;
            }
